...
var BodyActor, BodyWrapper, DomParser, ElementActor, ElementArticulator, ElementWrapper, GameUi, tj,
...
tj.createPlayer = function() {
  var actor, body, bodyActor, bodyDef, bodyWrapper, platformDef;
  platformDef = {
    top: 200,
    left: 200,
    width: 10,
  ...
  return tj.updatables.push(bodyActor);
};
...
tj.init = function() {
  ...
  return debugDraw.SetFlags(b2DebugDraw.e_shapeBit | b2DebugDraw.e_jointBit);
};
